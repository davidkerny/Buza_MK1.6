...
#define CUSTOM_MACHINE_NAME "Buza Rezearch MK1.6"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 27.5
  #define DEFAULT_Ki 2.92
  #define DEFAULT_Kd 64.77
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 171
  #define DEFAULT_bedKi 16.33
  #define DEFAULT_bedKd 448.93
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 800, 265 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 80, 80 }
 ...
 *
 *  - 
S 1.3/1.4 boards may use the 5V, GND, and Aux4->D32 pin:
 ...
 * Probe Type
 *
 * Allen Key Probes, Servo Probes, Z-Sled Probes,_PROBE, etc.
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 40    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 40    // Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (80*80)
#define HOMING_FEEDRATE_Z  (4*180)
...
#define PREHEAT_1_FAN_SPEED    25 // Value from 0 to 255
...
// http://reprap.org/wiA4988ki/RepRapDiscount_Smart_Controller
