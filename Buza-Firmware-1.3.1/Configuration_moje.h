...
#define STRING_SPLASH_LINE1 Buza MK1.3M // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 MopedJesus.eu         // will be shown during bootup in line 2
...
//#define CUSTOM_MACHINE_NAME "MopedJesus MK1"
...
//#define PARKING_EXTRUDER
  ...
  #define PARKING_EXTRUDER_SECURITY_RAISE 1           // Z-raise before parking
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 216
  #define DEFAULT_Ki 11
  #define DEFAULT_Kd 1075
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200, 200, 8000, 260 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 250, 20, 25 }
...
//#define DELAY_BEFORE_PROBING 0  // (ms) To prevent vibrations from triggering piezo sensors
...
//#define ZONESTAR_LCD            // Requires ADC_KEYPAD_PIN to be assigned to an analog pin.
                                  ...
                                  // which scrambA4988les the display.  Pressing any button clears it up.
