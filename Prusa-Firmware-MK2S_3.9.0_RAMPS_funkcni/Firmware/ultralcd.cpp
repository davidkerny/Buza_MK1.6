...
void lcd_wizard(WizState state)
{
    ...
    while (!end) {
		...
		case S::Run: //Run wizard?
			...
			wizard_event = lcd_show_multiscreen_message_yes_no_and_wait_P(_i("Hello! I am Buza and I will help you calibrate your printerrr!!"), false, true);////MSG_WIZARD_WELCOME c=20 r=7
			if (wizard_event) {
                state = S::Restore;
