...
// Printer name
#define CUSTOM_MENDEL_NAME "Dolly i3 MK2"
...
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,3200/8,161.3}
#endif
...
#define X_PROBE_OFFSET_FROM_EXTRUDER 27.5     // Z probe to nozzle X offset: -left  +right
